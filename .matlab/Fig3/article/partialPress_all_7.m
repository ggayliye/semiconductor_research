...
% FIXED PARAMETERS
%% =====================================================
F_frac_init = 1e-9;       % very small fraction
...
%% =====================================================
x0 = log([7.49903e-4; 2e-13]);   % b0 and c0
...
for i = 1:N
    ...
    ivar = 7.53238785702308E-08*((3/2)*(b + d + e) - 2*(c - 1.86489627968959E-20/c_safe) + 3*f ...
           - (3/2)*(0.0005 - (4/3)*GR*0.0005/2)) / sqrt(c_safe);
